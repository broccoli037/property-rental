        ...
        <div class="container">
                ...
                <div class="conmenu">
                    <ul style="text-align:center;list-style:none;display:inline;">
                        <a href="<?php echo SITEURL;?>admin/contact-request.php" style="text-decoration: none;color:white;"><li>Processing</li></a>
                        <a href="#"style="text-decoration: none;color:white;"><li>Processed</li></a>
                ...
                $offset = ($page - 1) * 16;
                $sql1 = "SELECT * FROM contact_request WHERE status='processed'";
                $res1 = mysqli_query($conn, $sql1);
                
                $sql = "SELECT * FROM contact_request WHERE status='processed' LIMIT $offset, 16";
