...
<body>
    ...
    <div class="container">
        ...
        <div class="product-cards">
            <div class="cat-title">Properties in <?php echo $lctn; ?> </div><br>
            ...
            <?php
                        ...
                        $offset = ($page - 1) * 9;
                        $sql1 = "SELECT * FROM property WHERE title LIKE '%$lctn%' OR location LIKE '%$lctn%' OR description LIKE '%$lctn%'";
                        $res1 = mysqli_query($conn, $sql1);
                    // sql query to search keyword
                    $sql = "SELECT * FROM property WHERE title LIKE '%$lctn%' OR location LIKE '%$lctn%' OR description LIKE '%$lctn%' LIMIT 9";
        ...
        <div class="pages-btn">
            <a href="<?php echo'?lctn='.$lctn; ?>">First</a>

            <a href="<?php if($page <=1){echo '#';}else{echo "?lctn=".$lctn."?page=".$page -1;} ?>"><</a>
            <?php 
                ...
                for($i = 1; $i <= $total; $i++){
                    ...
                    echo"<a href='?lctn=".$lctn."?page=$i'><span class='$active'>". $i ."</span></a>";
            ...
            <a href="<?php if($page >= $total){echo '#';}else{echo "?lctn=".$lctn."?page=".$page +1;} ?>">></a>
            <a href="<?php echo'?lctn='.$lctn.'?page='.$total; ?>">Last</a>
