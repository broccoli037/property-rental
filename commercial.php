...
<body>
    ...
    <div class=" cat-css">
       ...
       <div class="product-cards ">
           <div class="cat-title">Houses</div><br>
           <?php 
                ...
                $offset = ($page - 1) * 6;
                $sql1 = "SELECT * FROM property WHERE active='yes' AND property_type='4'";
                $res1 = mysqli_query($conn, $sql1);
                
                $sql = "SELECT * FROM property WHERE active='yes' AND property_type='4' LIMIT $offset, 6";
