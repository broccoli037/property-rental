...
<body>
    ...
    <div class=" cat-css">
        ...
        <div class="product-cards ">
            <div class="cat-title">Office</div><br>
            <?php 
               ...
               if(isset($_GET['page'])){
                ...
                $offset = ($page - 1) * 6;
                $sql1 = "SELECT * FROM property WHERE active='yes' AND property_type='3'";
                $res1 = mysqli_query($conn, $sql1);
                
                $sql = "SELECT * FROM property WHERE active='yes' AND property_type='3' LIMIT $offset, 6";
